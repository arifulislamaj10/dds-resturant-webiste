...
export const images = {
  ...
  longganisaSpam: "/images/longganisa-and-spam.jpeg",
  hotdogsNuggets: "/images/hotdogs-and-nuggets.jpeg",
  lumpiangShanghaiSiomai: "/images/lumpiang-shanghai-and-siomai.jpeg",
  hungarianSiomai: "/images/hungarian-sausage-and-siomai.jpeg",
  friedChickenSpam: "/images/fried-chicken-and-spam.jpeg",
  crispyFriesNuggets: "/images/crispy-fries-with-nuggets.jpeg",
...
export const facebookPosts: FacebookPost[] = [
  ...
  },
  {
    ...
    date: "Aug 15, 2026",
    dayLabel: "2 days ago",
    title: "Combo 3 — Hotdog & Nuggets",
    caption: "New batch cooked today. Crispy and ready to go.",
...
export const completedBulkOrders: BulkOrder[] = [
  ...
  {
    id: "bulk-2",
    title: "Combo meal party tray",
    quantity: "2 large trays",
    location: "St. Jude Village",
    date: "Aug 6, 2026",
    image: images.lumpiangShanghaiSiomai,
    description:
      "Combo meals and chao fan for a birthday party. Finished fast.",
    eventType: "Birthday",
  },
  {
    id: "bulk-3",
    ...
    image: images.longganisaSpam,
    description:
      "Longganisa, spam, and chao fan combos for a family event.",
    eventType: "Family",
  },
];
